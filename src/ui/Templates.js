                ...
                <div class="modal-body">
                    ...
                    <div class="upload-section" style="border-top:1px solid rgba(255,255,255,0.1); padding-top:20px; margin-top:20px;">
                        ...
                        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid rgba(0,243,255,0.2); text-align: center;">
                            ...
                            <button onclick="window.location.href='./journey.html'" class="cyber-btn"
                                style="width: 100%; margin-top: 10px; background: rgba(0, 243, 255, 0.1); border-color: var(--color-processing); color: var(--color-processing);">
                                JOUNREY</button>
                        </div>
                    </div>
                </div>
